    ...
    def retranslateUi(self, Dialog):
        ...
        for value in [self.slider1Value,self.slider2Value,self.slider3Value,self.slider4Value,self.slider5Value,self.slider6Value,self.slider7Value]:
            if(sliderInfo.get(value.objectName()[:-5]) != None):
                if((sliderInfo["slider1"]["label"]=="Red Factor" and sliderInfo["slider2"]["label"]=="Green Factor" and sliderInfo["slider3"]["label"]=="Blue Factor" and len(sliderInfo)==3) or (sliderInfo["slider1"]["label"]=="Sigma PSD" and len(sliderInfo)==1) or (sliderInfo["slider1"]["label"]=="Sigma" and sliderInfo["slider2"]["label"]=="Strength" and len(sliderInfo)==2) or (sliderInfo["slider1"]["label"]=="Alpha (Contrast)" and sliderInfo["slider2"]["label"]=="Beta (Brightness)" and len(sliderInfo)==2)):
